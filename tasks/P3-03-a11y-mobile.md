...
- Fresh `make check` after review fixes passed: 161 backend tests passed, 3 live tests skipped; 42 frontend tests passed; 14 contract examples and fixtures validated; all 9 Playwright smoke tests passed. Last 10 lines:
  ```text
    ✓  2 e2e/axe-gate.spec.ts:4:1 › axe audit rejects a serious violation (355ms)
    ✓  3 e2e/journey.spec.ts:18:1 › a survivor can walk through every placeholder stage (2.6s)
    ...
    ✓  6 e2e/programs.spec.ts:3:1 › S07 sees five program cards in Spanish urgency order (928ms)
    ✓  7 e2e/stage1.spec.ts:3:1 › stage 1 happy path in mock mode (410ms)
    ✓  8 e2e/stage1.spec.ts:21:1 › multi-county ZIP asks the survivor to choose (448ms)
    ✓  9 e2e/stage1.spec.ts:33:1 › ZIP without an active declaration shows other help (360ms)
